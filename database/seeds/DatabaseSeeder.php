...
class DatabaseSeeder extends Seeder {
    ...
    public function run() {
        ...
        DB::table('alloggi')->insert([
            ...
            ['titolo'=>'Bellissimo appartamento','regione' => 'Puglia','citta' => 'Bari', 'cap' => 60121, 'indirizzo' => 'Via Brecce Bianche', 'numero' => 21, 'prezzo' => 270.00 , 'descrizione' => 'Ampio appartamento a due passi dall\'università' ,'superficie' => 60,'letti_pl' => NULL,'letti_ap' => 3,'n_camere' => 3,'opzionato' => 0,'tipologia'=> 0,'locatore' => 5,'foto'=>'77561779.jpg','periodo_locazione' => 6,'eta_max'=>NULL, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ...
            ['titolo'=>'Favoloso posto letto','regione' => 'Piemonte','citta' => 'Torino', 'cap' => 60121, 'indirizzo' => 'Via Brecce Bianche', 'numero' => 23, 'prezzo' => 265.00 , 'descrizione' => 'Ampio appartamento a due passi dall\'università' ,'superficie' => 58,'letti_pl' => 1,'letti_ap' => 3,'n_camere' => 2,'opzionato' => 1,'tipologia'=> 1,'locatore' => 5,'foto'=>'AM1506.jpg','periodo_locazione' => 12,'eta_max'=>30, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['titolo'=>'Bellissimo posto letto','regione' => 'Lombardia','citta' => 'Milano', 'cap' => 60121, 'indirizzo' => 'Via Brecce Bianche', 'numero' => 21, 'prezzo' => 270.00 , 'descrizione' => 'Ampio appartamento a due passi dall\'università' ,'superficie' => 60,'letti_pl' => 1,'letti_ap' => 3,'n_camere' => 3,'opzionato' => 0,'tipologia'=> 1,'locatore' => 2,'foto'=>'77561779.jpg','periodo_locazione' => 6,'eta_max'=>45, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ...
            ['titolo'=>'Bellissimo posto letto','regione' => 'Veneto','citta' => 'Venezia', 'cap' => 60121, 'indirizzo' => 'Via Brecce Bianche', 'numero' => 21, 'prezzo' => 270.00 , 'descrizione' => 'Ampio appartamento a due passi dall\'università' ,'superficie' => 60,'letti_pl' => 1,'letti_ap' => 3,'n_camere' => 3,'opzionato' => 0,'tipologia'=> 1,'locatore' => 2,'foto'=>'77561779.jpg','periodo_locazione' => 12,'eta_max'=>30, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ...
            ['titolo'=>'Stupendo appartamento','regione' => 'Umbria','citta' => 'Perugia', 'cap' => 60121, 'indirizzo' => 'Via Brecce Bianche', 'numero' => 22, 'prezzo' => 260.00 , 'descrizione' => 'Ampio appartamento a due passi dall\'università' ,'superficie' => 55,'letti_pl' => NULL,'letti_ap' => 2,'n_camere' => 1,'opzionato' => 1,'tipologia'=> 0,'locatore' => 5, 'foto' => NULL, 'periodo_locazione' =>6,'eta_max'=>NULL, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],

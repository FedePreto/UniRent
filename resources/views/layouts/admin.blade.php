...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="{{route('admin')}}" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-bar-chart fa-fw w3-margin-right"></i>STATISTICHE</a> 
    <a href="{{route('faq.index')}}"  class="w3-bar-item w3-button w3-padding"><i class="fa fa-question-circle fa-fw w3-margin-right"></i>GESTISCI FAQS</a> 

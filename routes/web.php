...
Route::get('/Locatore/NewHome','LocatoreController@addHome')->name('updateProfilo');
Route::post('/Locatore/NewHome','LocatoreController@storeHome')->name('updateProfilo.store');

...
<a href="_blank" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-red" title="Effettua l'accesso al sito"><i class="fa fa-user"></i> Accedi</a>
=======
<a href="{{route('home')}}" class="w3-bar-item w3-button w3-hide-small" title="Torna all'inizio">HOME</a>
<a href="{{route('what')}}" class="w3-bar-item w3-button w3-hide-small" title="Cosa offriamo"><i class="fa fa-info-circle"></i>Servizio</a>
<a href="{{route('who')}}" class="w3-bar-item w3-button w3-hide-small" title="Il nostro profilo aziendale"><i class="fa fa-users"></i>Chi Siamo</a>
<a href="{{route('where')}}" class="w3-bar-item w3-button w3-hide-small" title="Dove trovarci">Dove Trovarci</a>
<a href ="{{route('faq')}}" class="w3-bar-item w3-button w3-hide-small" title="Frequently Asked Question">FAQ</a>
<a href="mailto:info@unirent.it" class="w3-bar-item w3-button w3-hide-small" title="Mandaci un messaggio">Contattaci</a>

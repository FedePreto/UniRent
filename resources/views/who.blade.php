...
<div class="w3-container w3-padding-32">
  ...
  <div class="w3-row-padding w3-grayscale">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="{{asset('img/gustavo.png')}}" alt="Rongo" style="width:100%">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src={{asset('img/howard.png')}} alt="Fede" style="width:100%">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src={{asset('img/garrett.png')}} alt="Greg" style="width:100%">
      <h3>Gregorio Vecchiola</h3>
      <p class="w3-opacity">Parasite</p>
      <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
      <p><button class="w3-button w3-light-grey w3-block">Contact</button></p>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
